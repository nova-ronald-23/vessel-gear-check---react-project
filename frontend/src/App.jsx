...
import Defultmain from './components/Checklist/defultmain';
import Modifydefult from './components/Checklist/modifydefult';
import Create from './components/Checklist/create';
...
import Arrivalmain from "./components/Checklist/Arrivalmain";
import Departuremain from "./components/Checklist/Departuremain";
  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path="/defaultchecklist" element={<DefaultChecklistPage/>}/>
        ...
        <Route path="/defultmain" element={<Defultmain/>}/>
        <Route path="/Arrivalmain" element={<Arrivalmain/>}/>
        <Route path="/Departuremain" element={<Departuremain/>}/>
