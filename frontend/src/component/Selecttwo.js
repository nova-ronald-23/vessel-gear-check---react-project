            ...
            <div className="green-inner">
              ...
              <div className="box">
                <div className='selection'>
                    <input type='text' placeholder='New Checklistname' style={{width:250, height: 48, border: 3,
                        marginTop: 69, marginLeft: 19,outline: 'none', paddingLeft: 54, fontSize: 13 }}></input>
