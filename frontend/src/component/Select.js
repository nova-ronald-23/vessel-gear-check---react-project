            ...
            <div className="green-inner">
              ...
              <div className="box">
                <div className='selection'>
                    <input type='text' placeholder='Enter a New Department' style={{width:250, height: 48, border: 3,
                        marginTop: 69, marginLeft: 19,outline: 'none', paddingLeft: 35, fontSize: 13 }}></input>
